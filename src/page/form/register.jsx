...
export default class FormRegister extends Component {
  ...
  render() {
    let { isSub, previewTitle, previewImage, fileList, previewVisible } =
      this.state;
        ...
        <Card title="注册表单">
          <Form autoComplete="off" ref="form1">
            ...
            <FormItem
              ...
              {...formItemLayout}
            >
              <Switch onChange={() => this.setState({ isSub: !isSub })} />
            </FormItem>
            {isSub ? (
              <FormItem name="subTime" label="推送时间" {...formItemLayout}>
                <TimePicker />
              </FormItem>
            ) : null}
            <FormItem
            ...
            <FormItem name="address" label="详细地址" {...formItemLayout}>
              <TextArea
                autoSize={{
                  minRows: 3,
                  maxRows: 5,
            ...
            <FormItem name="userFace" label="头像" {...formItemLayout}>
              <Upload
            ...
            <FormItem name="isAgree" {...offsetLayout}>
              <Checkbox>
                我已阅读并同意
                <a href="#">用户隐私协议</a>
              </Checkbox>
